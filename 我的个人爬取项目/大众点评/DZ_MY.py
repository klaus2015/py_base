...
class DianpingComment:
    ...
    def _get_css_link(self, url):
        """
            请求评论首页，获取css样式文件
            url =  'http://www.dianping.com/shop/67161528/review_all/p1'
        """
        ...
        return css_link
        # http://s3plus.meituan.net/v1/mss_0a06a471f9514fc79c981b5466f56b91/svgtextcss/8ec24fa95df38b2692a7360856f271f3.css
